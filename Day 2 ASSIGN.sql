...
insert into students Values (101,'Suresh','Kumar', '1995-11-16' , 'sureshkumar@gmail.com',9958654512);
insert into students Values (102,'Ben','Stokes', '1995-10-16' ,'benstokes@gmail.com',9958656512);
insert into students Values (103,'Lockie','Ferguson', '1995-08-16' , 'lockieferguson@gmail.com',9985654512);
insert into students Values (104,'David','Warner', '1995-06-16' , 'davidwarner@gmail.com',9968554512);
insert into students Values (105,'Suresh','Raina', '1995-04-16' , 'sureshraina@gmail.com',9858654521);
insert into students Values (106,'Aaron','Smith', '1995-02-16' , 'aaronsmith@gmail.com',9598654512);
insert into students Values (107,'Chris','Gayle', '1995-01-16' , 'chrisgayle@gmail.com',9188654512);
insert into students Values (108,'Carolos','Brathwaite', '1995-09-16' , 'sureshkumar@gmail.com',9818654512);
insert into students Values (109,'Fraser','Mcgurk', '1995-07-16' , 'frasermcgurk@gmail.com',9798654512);
insert into students Values (110,'Brandon','King', '1995-05-16' , 'brandonking@gmail.com',9368654512);
...
insert into students values (111,'John','Doe','1995-08-15','johndoe@gmail.com',1234567890);
insert into enrollments values (411,111,304,'2003-11-01');
update teacher set email = 'viratkohli18@gmail.com' where teacher_id =203;
delete from enrollments where student_id = 102 and course_id =302;
update courses set teacher_id = 201 where teacher_id = 205;
delete from students where student_id = 101 ;
update payments set amount = 11500 where amount = 12000;
